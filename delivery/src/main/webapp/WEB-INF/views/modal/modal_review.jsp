...
<!-- 리뷰 쓰기 모달 -->
    ...
    <div class="review_modal modal">
	    ...
	    <form class="upload-form" onsubmit="reviewUpload(event)"> 
    	<div class="modal_box">
	    	<div class="score_box">
    ...
    <div class="review_modify_modal modal">
	    ...
	    <form class="update-form" onsubmit="reviewUpdate(event)">
    	<div class="modal_box">
	    	<div class="score_box">
				<i class="far fa-star"></i>
				<i class="far fa-star"></i>
	    	...
	    	<input type="hidden" name="score2" class="score" >
	    	
	    	<div class="review_text">
	    		<textarea rows="10" cols="50" name="reviewContent2" maxlength="500" ></textarea>
	    	</div>
	    	...
	    	<div class="img_box">
	    		...
	    		<div>
	    			<img class="preview" name="preview">
	    			<button type="button" class="img_close"><i class="fas fa-times"></i></button>
    			</div>
	    	</div>
    	</div>
    	...
    	<div id="btn_box">
    		<input type="hidden" class="order_num" name="orderNum2">
    		<input type="hidden" class="store_id" name="storeId2">
 			<button type="button" class="closeB">취소</button>
	...
	<!-- <script src="/js/modal/modal_review.js" ></script> -->